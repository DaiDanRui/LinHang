<?php
/* Smarty version 3.1.29, created on 2016-03-13 08:46:13
  from "/Applications/MAMP/htdocs/LinHang/tpl/Reward&Market/market-main.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_56e51ac5252a59_40448189',
  'file_dependency' => 
  array (
    'fceae7ba6cf817d7a3520b301410beb0c658b317' => 
    array (
      0 => '/Applications/MAMP/htdocs/LinHang/tpl/Reward&Market/market-main.html',
      1 => 1457854933,
      2 => 'file',
    ),
  ),
...
function content_56e51ac5252a59_40448189 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
?>
            <div class="item">
                <div class="item-header-main">
                    <img class="img-to-set" src="<?php echo $_smarty_tpl->tpl_vars['item']->value['url'];?>
">
...
?>
                        <img class="img-to-set-2" src="<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
">
                    <?php
        ...
        <div class="menu-left" tabindex="0" style="width: 0">
            ...
            <div class="content" id="con1" style="display: none">
                <div class="menu-item">
                    ...
                    <button type="submit" name="price-high">最豪华</button>
                </div>
                <div class="menu-item">
                    <img src="img/icon-circle2.png">
                    <button type="submit" name="price-low">最实惠</button>
                </div>
            </div>
            ...
            <div class="content" id="con3" style="display: none;">
                <div class="menu-item">
                    <img src="img/icon-circle1.png">
                    <button type="submit" name="type-math">理工</button>
                </div>
                <div class="menu-item">
                    <img src="img/icon-circle2.png">
